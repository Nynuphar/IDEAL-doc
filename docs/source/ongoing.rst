Worflow: onboard an ongoing study to CHIL by importing a patient list
########################################################################################################
...
.. warning:: Before importing the list of patients, first make sure you are trying to import a .CSV file and that this file follows the data format defined on CHIL (see above how to do this).
...
The patient list should be checked for repeated entries before importing them in CHIL. In the future we plan to develop a check which prevents these situations, but currently be aware that:
