...
* March 2025:
  * Matching by Patient Hospital ID when performing a bulk import of a pre-existing study to CHIL
...
* January 2025:
  ...
  *	Template letters: create letters with patient information from CHIL
...
* 01-April-2005:
* Regarding CHIL matching Hospital ID - Study ID when Hospital ID is provided in the study list being imported:
...
These are the current issues we know about and will be fixed in the next CHIL release.
