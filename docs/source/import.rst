...
Let's go step by step, taking the above data as example. In CHIL, in the "**My Study Data Format**", you can see the following fields:
   ...
   * "Gender representation": CHIL representation of Female is defined by "**F**", Male by "**M**" and "**Other**" to "**O**".
      * in our study, the gender is also set to "**F**" and "**M**" - this does not need to be updated.
   * "Boolean representation": here CHIL expects the value True/False
